...
vim.keymap.set('n', '<C-u>', '<C-u>zz', { desc = 'Page-up and middle of the buffer' })
...
vim.keymap.set('n', '<leader>Y', [["+Y]], { desc = 'Yank into the clipboard' })
vim.keymap.set({ 'n', 'v' }, '<leader>d', [["_d]], { desc = 'Delete without yanking' })

vim.keymap.set('n', '<C-f>', '<cmd>silent !tmux neww ~/.local/bin/tmux-sessionizer.sh<CR>')

vim.keymap.set('n', '<leader>s', [[:%s/\<<C-r><C-w>\>/<C-r><C-w>/gI<Left><Left><Left>]], { desc = 'Replace word under the cursor in the whole file' })
...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>cs', builtin.grep_string, { desc = '[S]earch current [W]ord' })
    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          map('<leader>f', vim.lsp.buf.format, 'Format opened buffer')
